...
--INSERT INTO public.book (type, authorship, subject, title, year, description, namedpersons, notes, located, modifiedby, lastupdated, publisher, author) 
--VALUES ('x', 1203, "x", "x", "x", "x", "System", CURRENT_DATE, "x", "x");
